...
const String loginVersionPrefix = 'Versión';
...
const String menuAdopcionesDesc = 'Gestiona solicitudes y procesos de adopción de animales.';
const String menuCampanasTitle = 'Gestión de Campañas';
const String menuCampanasDesc = 'Crea y administra campañas de concientización y eventos.';
const String menuAnimalesTitle = 'Gestión de Animales';
const String menuAnimalesDesc = 'Registra y administra los animales del refugio.';