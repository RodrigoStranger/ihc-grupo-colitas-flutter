...
import 'package:ihc_grupo_colitas_flutter/models/voluntariado_model.dart';
...
class _VoluntariadoScreenState extends State<VoluntariadoScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<VoluntariadoViewModel>().fetchSolicitudes();
      }
    });
  }
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >=
      ...
      final viewModel = context.read<VoluntariadoViewModel>();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Lista de solicitudes de voluntariado
          Expanded(
            child: Consumer<VoluntariadoViewModel>(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'Error al cargar solicitudes: ${viewModel.error}',
  ...
  List<Voluntariado> _filtrarSolicitudes(List<Voluntariado> solicitudes) {
    if (_filtroEstado == 'Todos') {
      return solicitudes;
    }
    ...
    return solicitudes.where((solicitud) => 
      solicitud.estadoSolicitanteVoluntariado.toLowerCase() == estadoBackend.toLowerCase()).toList();
  }

  // Método para contactar por WhatsApp
  Future<void> _contactarWhatsApp(Voluntariado solicitud) async {
    final numero1 = solicitud.numero1SolicitanteVoluntariado;
    final numero2 = solicitud.numero2SolicitanteVoluntariado;

    // Si solo hay un número, usar ese directamente
    if (numero2 == null || numero2.isEmpty) {
      await _abrirWhatsApp(numero1, solicitud.nombreSolicitanteVoluntariado, solicitud.descripcionSolicitanteVoluntariado);
      return;
    }
          ...
          children: [
            Container(
              ...
              child: ListTile(
                ...
                onTap: () {
                  ...
                  _abrirWhatsApp(numero1, solicitud.nombreSolicitanteVoluntariado, solicitud.descripcionSolicitanteVoluntariado);
                },
              ),
            ),
            ...
            Container(
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _abrirWhatsApp(numero2, solicitud.nombreSolicitanteVoluntariado, solicitud.descripcionSolicitanteVoluntariado);
                },
              ),
            ),
          ],
  ...
  Future<void> _abrirWhatsApp(String telefono, String nombre, String descripcionVoluntariado) async {
    try {
      ...
      final mensaje = Uri.encodeComponent(
        'Hola $nombre, te contactamos desde Grupo Colitas Arequipa sobre tu solicitud de voluntariado para: $descripcionVoluntariado'
      );
  ...
  // Función para mostrar modal de confirmación para concluir voluntariado
  Future<void> _mostrarConfirmacionConcluir(BuildContext context, Voluntariado solicitud) async {
    return showDialog(
      context: context,
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(
        ...
        content: Column(
          ...
          children: [
            Text(
              '¿Estás seguro de que deseas marcar esta solicitud de voluntariado como concluida?',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Esta acción marcará la solicitud como exitosamente completada.',
                      style: TextStyle(
  ...
  // Función para mostrar modal de confirmación para no concluir voluntariado
  Future<void> _mostrarConfirmacionNoConcluir(BuildContext context, Voluntariado solicitud) async {
    return showDialog(
      context: context,
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(
        ...
        content: Column(
          ...
          children: [
            Text(
              '¿Estás seguro de que deseas marcar esta solicitud de voluntariado como no concluida?',
              style: TextStyle(fontSize: 16),
            ),
            const SizedBox(height: 12),
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Esta acción marcará la solicitud como no completada o fallida.',
                      style: TextStyle(
  ...
  Widget _buildSolicitudCard(BuildContext context, Voluntariado solicitud) {
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Voluntariado de: ${solicitud.nombreSolicitanteVoluntariado}',
                    ...
                    Text(
                      'Solicitante: ${solicitud.nombreSolicitanteVoluntariado}',
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                    const SizedBox(height: 4),
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _getEstadoColor(solicitud.estadoSolicitanteVoluntariado),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Text(
                            solicitud.estadoSolicitanteVoluntariado,
          ...
          Text(
            'Teléfono 1: ${solicitud.numero1SolicitanteVoluntariado}',
            style: Theme.of(context).textTheme.bodySmall,
          ),
          if (solicitud.numero2SolicitanteVoluntariado != null && solicitud.numero2SolicitanteVoluntariado!.isNotEmpty) ...[
            Text(
              'Teléfono 2: ${solicitud.numero2SolicitanteVoluntariado}',
              style: Theme.of(context).textTheme.bodySmall,
            ),
          ],
          const SizedBox(height: 8),
          Text(
            'Fecha: ${_formatearFecha(solicitud.fechaSolicitanteVoluntariado)}',
          ...
          // Descripción
          if (solicitud.descripcionSolicitanteVoluntariado.isNotEmpty) ...[
            Text(
            ...
            const SizedBox(height: 4),
            Text(
              solicitud.descripcionSolicitanteVoluntariado,
              style: Theme.of(context).textTheme.bodySmall,
              maxLines: 3,
          ...
          if (solicitud.estadoSolicitanteVoluntariado.toLowerCase().trim() == 'pendiente') ...[
          ...
          ] else if (solicitud.estadoSolicitanteVoluntariado.toLowerCase().trim() == 'concluido') ...[
          ...
          ] else if (solicitud.estadoSolicitanteVoluntariado.toLowerCase().trim() == 'no concluido') ...[
            ...
            Column(
              children: [
                Text(
                  'Estado desconocido: "${solicitud.estadoSolicitanteVoluntariado}"',
  ...
  Future<void> _cambiarEstado(
    ...
    try {
      await viewModel.cambiarEstadoSolicitud(
        solicitud.idSolicitanteVoluntariado!,
        nuevoEstado,
      );
      if (!mounted) return;
      
      String mensaje = nuevoEstado == 'Concluido' 
          ? 'Solicitud de voluntariado marcada como concluida con éxito'
          : 'Solicitud de voluntariado marcada como no concluida con éxito';
